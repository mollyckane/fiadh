/*
This file contains unit tests for the expenses routes of the application.
It uses Jest and Supertest to test the GET, POST and DELETE endpoints for expenses.
*/
